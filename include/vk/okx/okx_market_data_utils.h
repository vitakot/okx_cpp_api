...
/// Parse 1-minute candlestick CSV data into Candle structures
/// CSV format: ts,o,h,l,c,vol,volCcy,volCcyQuote,confirm
...
/// Parse funding rate CSV data into FundingRate structures
/// CSV format: instId,fundingRate,realizedRate,fundingTime
/// @param csvData Raw CSV bytes (UTF-8 encoded)
